...
exports.getUsers = [
    ...
    (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const { total, results } = yield (0, users_service_1.showUsers)(usersQueryParams);
...
const getUserById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const user = yield (0, users_service_1.findUser)(id);
        if (user)
            res.status(200).json({ data: user });
        else
...
exports.updateUserHandler = [
    ...
    (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const { id } = req.params;
        try {
            const updatedUser = yield (0, users_service_1.updateUser)(id, req.body);
            if (updatedUser) {
...
exports.deleteUserHandler = [
    ...
    (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const { id } = req.params;
        try {
            const deletedUser = yield (0, users_service_1.deleteUser)(id);
            if (deletedUser) {
